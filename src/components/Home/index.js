...
export const HomeRecentProjects = lazy(() => import("./HomeRecentprojects"))
export const HomeAchievements = lazy(() => import("./HomeAchievements"))
export const HomeDomains = lazy(() => import("./HomeDomains"))
